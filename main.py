...
from sqlite import sqlite_add_new_user, sqlite_update_posts, sqlite_clear_posts, sqlite_update_added_users, \
    sqlite_select_posts, sqlite_select_all_users_can_send_message, sqlite_add_new_user_optional, \
...
if not API_TOKEN or not API_HASH or not API_ID:
    print('Добавьте API_TOKEN, API_HASH, API_ID в переменные среды.')
    exit(2)
